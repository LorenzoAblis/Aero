...
class WeatherService {
    ...
    formatWeeklyWeatherData = () => {
        ...
        while (
            ...
            const DayData = {
                ...
                weather_code_icon: this.utils.convertWeatherCode(this.rawWeatherData["daily"]["weather_code"][minIndex], "logo"),
            };
    ...
    formatHourlyWeatherData = () => {
        this.hourlyWeatherData = [];
        let minIndex = this.rawWeatherData["hourly"]["time"].indexOf(this.utils.getDateTime()) + 1;
        ...
        while (
            ...
            const HourData = {
                ...
                weather_code_icon: this.utils.convertWeatherCode(this.rawWeatherData["hourly"]["weather_code"][minIndex], "icon"),
                temp: Math.round(this.rawWeatherData["hourly"]["temperature_2m"][minIndex]),
            };
    ...
    formatCurrentWeatherData = () => {
        let timeIndex = this.rawWeatherData["hourly"]["time"].indexOf(this.utils.getDateTime());

        this.currentWeatherData = {
            temp: Math.round(this.rawWeatherData["hourly"]["temperature_2m"][timeIndex]),
            humidity: this.rawWeatherData["hourly"]["relative_humidity_2m"][timeIndex],
            feelslike: Math.round(
                this.rawWeatherData["hourly"]["apparent_temperature"][timeIndex]
            ),
            precip: this.rawWeatherData["hourly"]["precipitation_probability"][timeIndex],
            pressure: Math.round(
            ...
            temp_max: Math.round(this.rawWeatherData["daily"]["temperature_2m_max"][0]),
            temp_min: Math.round(this.rawWeatherData["daily"]["temperature_2m_min"][0]),
            ...
            uvClass: this.utils.getUvClass(this.rawWeatherData["daily"]["uv_index_max"][0]),
            weather_code: this.utils.convertWeatherCode(this.rawWeatherData["daily"]["weather_code"][0], "text"),
            weather_code_icon: this.utils.convertWeatherCode(this.rawWeatherData["daily"]["weather_code"][0], "icon"),
        };
    };
